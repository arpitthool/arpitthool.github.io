...
const greeting = {
  ...
  subTitle: emoji(
    "A passionate Software Engineer 🚀 with expertise in Java, Python, C# and a wide range of technologies, delivering innovative solutions and driving seamless user experiences."
    ),
  resumeLink:
...
const socialMediaLinks = {
  ...
  linkedin: "https://www.linkedin.com/in/arpit-thool/",
  ...
  experience: [
    {
      ...
      descBullets: [
        ...
        "Designed and implemented a web app using Python Flask with SSO feature to test the CAS and SAML login service.",
      ]
    },
    {
